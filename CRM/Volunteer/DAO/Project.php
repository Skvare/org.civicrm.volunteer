 ...
 * substantive way.
 *
 * The authoritative definition of this entity is schema/VolunteerProject.entityType.php.
 ...
 * @property int|string $loc_block_id
 * @property int|string $campaign_id
 */
class CRM_Volunteer_DAO_Project extends CRM_Volunteer_DAO_Base {
